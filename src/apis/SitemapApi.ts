...
export class SitemapApi extends runtime.BaseAPI {
     ...
     * Get Sitemap
     */
    async sitemapRaw(requestParameters: SitemapRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<EntityinterfaceInner>>> {
     ...
     * Get Sitemap
     */
    async sitemap(requestParameters: SitemapRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<EntityinterfaceInner>> {
