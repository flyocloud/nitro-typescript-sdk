...
export class EntitiesApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for entityBySlug without sending the request
     */
    async entityBySlugRequestOpts(requestParameters: EntityBySlugRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/entities/slug/{slug}`;
    ...
    async entityBySlugRaw(requestParameters: EntityBySlugRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Entity>> {
        const requestOptions = await this.entityBySlugRequestOpts(requestParameters);
    ...
    /**
     * Creates request options for entityByUniqueid without sending the request
     */
    async entityByUniqueidRequestOpts(requestParameters: EntityByUniqueidRequest): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/entities/uniqueid/{uniqueid}`;
        urlPath = urlPath.replace('{uniqueid}', encodeURIComponent(String(requestParameters['uniqueid'])));
    ...
    async entityByUniqueidRaw(requestParameters: EntityByUniqueidRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Entity>> {
        const requestOptions = await this.entityByUniqueidRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
