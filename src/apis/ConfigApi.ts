...
export class ConfigApi extends runtime.BaseAPI {
     ...
     * Get Config
     */
    async configRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConfigResponse>> {
     ...
     * Get Config
     */
    async config(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConfigResponse> {
