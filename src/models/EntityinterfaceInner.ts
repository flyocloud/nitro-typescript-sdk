 ...
 */
export function instanceOfEntityinterfaceInner(value: object): value is EntityinterfaceInner {
    return true;
}
...
export function EntityinterfaceInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityinterfaceInner {
    ...
    return {
        ...
        'routes': json['routes'] == null ? undefined : RoutesFromJSON(json['routes']),
    };
}

export function EntityinterfaceInnerToJSON(json: any): EntityinterfaceInner {
    return EntityinterfaceInnerToJSONTyped(json, false);
}

export function EntityinterfaceInnerToJSONTyped(value?: EntityinterfaceInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'href': value['href'],
        'routes': RoutesToJSON(value['routes']),
    };
}
