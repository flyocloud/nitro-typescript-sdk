...
import type { ContainerPage } from './ContainerPage';
import {
    ContainerPageFromJSON,
    ContainerPageFromJSONTyped,
    ContainerPageToJSON,
    ContainerPageToJSONTyped,
} from './ContainerPage';
 ...
 */
export function instanceOfConfigResponseContainersValue(value: object): value is ConfigResponseContainersValue {
    return true;
}
...
export function ConfigResponseContainersValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfigResponseContainersValue {
    ...
    return {
        ...
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ContainerPageFromJSON)),
...
export function ConfigResponseContainersValueToJSON(json: any): ConfigResponseContainersValue {
    return ConfigResponseContainersValueToJSONTyped(json, false);
}

export function ConfigResponseContainersValueToJSONTyped(value?: ConfigResponseContainersValue | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ContainerPageToJSON)),
        'uid': value['uid'],
