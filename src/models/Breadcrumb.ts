...
export function BreadcrumbToJSON(json: any): Breadcrumb {
    return BreadcrumbToJSONTyped(json, false);
}

export function BreadcrumbToJSONTyped(value?: Breadcrumb | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
