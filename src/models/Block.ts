...
import type { BlockSlot } from './BlockSlot';
import {
    BlockSlotFromJSON,
    BlockSlotFromJSONTyped,
    BlockSlotToJSON,
} from './BlockSlot';
...
export interface Block {
    ...
    /**
     * 
     * @type {{ [key: string]: BlockSlot; }}
     * @memberof Block
     */
    slots?: { [key: string]: BlockSlot; };
}
...
export function BlockFromJSONTyped(json: any, ignoreDiscriminator: boolean): Block {
    ...
    return {
        ...
        'slots': json['slots'] == null ? undefined : (mapValues(json['slots'], BlockSlotFromJSON)),
    };
}
...
export function BlockToJSON(value?: Block | null): any {
    ...
    return {
        ...
        'slots': value['slots'] == null ? undefined : (mapValues(value['slots'], BlockSlotToJSON)),
    };
}
