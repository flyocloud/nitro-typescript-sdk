...
export function PagesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PagesInner {
    ...
    return {
        ...
        'children': json['children'] == null ? undefined : ((json['children'] as Array<any>).map(PagesInnerFromJSON)),
    };
}
...
export function PagesInnerToJSON(value?: PagesInner | null): any {
    ...
    return {
        ...
        'children': value['children'] == null ? undefined : ((value['children'] as Array<any>).map(PagesInnerToJSON)),
    };
}
