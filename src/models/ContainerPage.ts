 ...
 * @export
 */
export const ContainerPageTypeEnum = {
    page: 'page',
    email: 'email',
    file: 'file',
    url: 'url',
    tel: 'tel',
    nitropagelink: 'nitropagelink',
    nitrodetaillink: 'nitrodetaillink'
} as const;
export type ContainerPageTypeEnum = typeof ContainerPageTypeEnum[keyof typeof ContainerPageTypeEnum];


/**
 * Check if a given object implements the ContainerPage interface.
 */
export function instanceOfContainerPage(value: object): value is ContainerPage {
    return true;
}
...
export function ContainerPageToJSON(json: any): ContainerPage {
    return ContainerPageToJSONTyped(json, false);
}

export function ContainerPageToJSONTyped(value?: ContainerPage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
