...
export function PageFromJSONTyped(json: any, ignoreDiscriminator: boolean): Page {
    ...
    return {
        ...
        'breadcrumb': json['breadcrumb'] == null ? undefined : ((json['breadcrumb'] as Array<any>).map(PageBreadcrumbInnerFromJSON)),
    };
}
...
export function PageToJSON(value?: Page | null): any {
    ...
    return {
        ...
        'breadcrumb': value['breadcrumb'] == null ? undefined : ((value['breadcrumb'] as Array<any>).map(PageBreadcrumbInnerToJSON)),
    };
}
