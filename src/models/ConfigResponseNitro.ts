 ...
 */
export function instanceOfConfigResponseNitro(value: object): value is ConfigResponseNitro {
    return true;
}
...
export function ConfigResponseNitroToJSON(json: any): ConfigResponseNitro {
    return ConfigResponseNitroToJSONTyped(json, false);
}

export function ConfigResponseNitroToJSONTyped(value?: ConfigResponseNitro | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
